...
def get_features6(file):
    file = file.replace("genres","genreschord")
    file = file.replace(".wav",".chord.npy")
    print file
    feature6_set = np.load(file)
    return feature6_set
...
def getSplitData(p=40,featureset = 0):
    genre_list = ["classical", "jazz", "country", "pop", "rock", "metal"]
...
def testfeature5():
    ...
    gridSearch(Xtrain,ytrain,Xtest,ytest,2)
def testfeature6():
    Xtrain,ytrain,Xtest,ytest = getSplitData(6)
    #Xtrain, Xtest = getScaledData(Xtrain, Xtest):
    gridSearch(Xtrain,ytrain,Xtest,ytest,0)
    gridSearch(Xtrain,ytrain,Xtest,ytest,1)
    gridSearch(Xtrain,ytrain,Xtest,ytest,2)
...
def knn1(p = 80):
    #genre_list = ["classical", "jazz", "country", "pop", "rock", "metal"]
    genre_list = ["jazz", "country", "pop", "rock", "metal"]
    Xtrain,ytrain,Xtest,ytest = getSplitData(p = p)
    #Xtrain, Xtest = getScaledData(Xtrain, Xtest)
    ntest = Xtest.shape[0]
    ntrain = Xtrain.shape[0]
...
if __name__ == '__main__':
    ...
    #knn1(120)
    #knn1(140)
    for i in [40,50,60,70,80,90,100,110,120,130,140,150,160,170,175]:#150 0.348
        print "i", i
        knn1(i)
    #testchord()